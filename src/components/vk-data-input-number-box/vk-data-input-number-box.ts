...
//import type { DefineComponent } from '@uni-helper/uni-app-types'
//import { Component } from '@uni-helper/uni-app-types'
import VkDataInputNumberBox from './vk-data-input-number-box.vue'
...
// }
/** 步进器 */
export type InputNumberBox = DefineComponent<Partial<InputNumberBoxProps>>
